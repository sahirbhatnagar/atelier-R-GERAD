...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{rcode}\label{unnamed-chunk-8}\hfill{}\begin{alltt}
...
\begin{frame}{Les structures de données en R}
\ctable[caption={Les structures de données en R},label=tab:table1,pos=h!,doinside=\small]{ccccc}{\tnote{tout le contenu doit être du même type}\tnote[b]{le contenu peut être de différent types}
}{
    																\FL
